...
class CP24(pigmentProtein):
    def __init__(self, n = 1):
        self.type = "CP24"
        self.n = n
        self.N_Chl_a = 5*self.n
        self.N_Chl_b = 5*self.n
        self.N_Chls = self.N_Chl_a + self.N_Chl_b
...
class CP26(pigmentProtein):
    def __init__(self, n = 1):
        self.type = "CP26"
        self.n = n        
        self.N_Chl_a = 8*self.n
        self.N_Chl_b = 4*self.n
        self.N_Chls = self.N_Chl_a + self.N_Chl_b
...
class minors(pigmentProtein):
    def __init__(self, n_CP24 = 1, n_CP26 = 1, n_CP29 = 1):
        ...
        self.N_Chl_a = self.CP24.N_Chl_a + self.CP26.N_Chl_a + self.CP29.N_Chl_a
        self.N_Chl_b = self.CP24.N_Chl_b + self.CP26.N_Chl_b + self.CP29.N_Chl_b   
...
class PSII(pigmentProtein):
    def __init__(self, n_Core = 1, n_CP24 = 1, n_CP26 = 1, n_CP29 = 1, n_LHCII = 2.):
        ...
        self.N_Chl_a = self.Core.N_Chl_a + self.minors.N_Chl_a + self.LHCII.N_Chl_a
        self.N_Chl_b = self.minors.N_Chl_b + self.LHCII.N_Chl_b
        self.N_Chls = self.N_Chl_a + self.N_Chl_b

    def actualize_n_LHCII(self, n_LHCII):
        self.LHCII = LHCII(n_LHCII)
        self.N_Chl_a = self.Core.N_Chl_a + self.minors.N_Chl_a + self.LHCII.N_Chl_a
        self.N_Chl_b = self.minors.N_Chl_b + self.LHCII.N_Chl_b
        self.N_Chls = self.N_Chl_a + self.N_Chl_b
...
print "LHCII"
print WTGL200.thylakoidMembrane.n_LHCII
print WTGL600.thylakoidMembrane.n_LHCII
print WTGL1800.thylakoidMembrane.n_LHCII
print " "
print dLhcb2GL200.thylakoidMembrane.n_LHCII
print dLhcb2GL600.thylakoidMembrane.n_LHCII
print dLhcb2GL1800.thylakoidMembrane.n_LHCII
print "PSI"
print WTGL200.n_PSI
print WTGL600.n_PSI
